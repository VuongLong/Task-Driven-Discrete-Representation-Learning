...
def main():
	...
	if args.run_name is None:
		args.run_name = args.unique_name
	args.out_dir = args.out_root / args.run_name
	...
	for test_env in dataset.environments:
		with open('domainbed/configs/{}_{}.json'.format(args.dataset, test_env), "r") as inp:
